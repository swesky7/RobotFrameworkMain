...
Suite Setup    Log To Console    Run this before the suite.
Suite Teardown    Log To Console    Run this after the suite
Test Setup    Log To Console    Run this before every test case
Test Teardown    Log To Console    Run this after every test case
